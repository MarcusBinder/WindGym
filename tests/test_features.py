...
def get_base_yaml_dict(nx=2, ny=1, history_length=5, window_length=2, history_n=1): # Changed default nx to 2
    """
...
class TestSpecificFeatures:
    ...
    def test_wind_direction_features_in_observations(
        ...
        config_dict["ws_mes"]["ws_current"] = False; config_dict["ws_mes"]["ws_rolling_mean"] = False; config_dict["ws_mes"]["ws_history_N"] = 0
        config_dict["power_mes"]["power_current"] = False; config_dict["power_mes"]["power_rolling_mean"] = False; config_dict["power_mes"]["power_history_N"] = 0
    ...
    def test_specific_measurement_configurations(
        ...
        expected_dim = calculate_expected_obs_dim(config_dict, n_turb_nx) # Pass correct n_turb
        actual_dim = env.observation_space.shape[0]
    ...
    def test_track_power_not_implemented(self, temp_yaml_filepath_factory, mock_mann_methods):
        ...
        with pytest.raises(NotImplementedError, match="The Track_power is not implemented yet"):
            env = WindFarmEnv(turbine=V80(), yaml_path=yaml_filepath, reset_init=True, seed=42, turbtype="None")
