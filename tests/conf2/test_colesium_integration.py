...
class TestColiseumAndAgentIntegration:
    ...
    def test_coliseum_runs_end_to_end_with_pywake_agent(self, temp_yaml_file_integration):
        """
        ...
        pywake_agent = PyWakeAgent(
            x_pos=x_pos, y_pos=y_pos, turbine=V80(),
        ...
        env_factory = lambda: FarmEval(
            ...
            reset_init=True, finite_episode=True, Baseline_comp=False
        )
        
        coliseum = Coliseum(env_factory, agents={"PyWake": pywake_agent}, n_passthrough=1.0)
    ...
    def test_environment_interprets_pywake_action_correctly(self, temp_yaml_file_integration):
        """
        ...
        env = FarmEval(
            turbine=V80(), x_pos=x_pos, y_pos=y_pos,
            yaml_path=temp_yaml_file_integration, turbtype="None",
            reset_init=True, Baseline_comp=False, yaw_step=YAW_STEP
        )
        ...
        assert final_yaw_t1 == YAW_STEP, "Turbine did not yaw by the correct amount in one step."
